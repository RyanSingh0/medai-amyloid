...
from model_v3 import BaselineCNN
from losses_v1 import get_criterion
...
def main():
    ...
    parser.add_argument("--pretrained", type=str, default=None,
                    help="Path to MedicalNet resnet_34.pth")
    ...
    median_cl = train_ds.centiloids.median()
    model = BaselineCNN(
    ...
    # checkpoint = torch.load("checkpoints/best_model.pt", weights_only=True)
